...
function declareWinner(player) {
  ...
  diceButton.disabled = true; // Disable the dice button when a player wins
  holdButton.disabled = true; // Disable the "Hold Game" button when a player wins
}
function newGame() {
  player1CurrentScore = 0;
  player2CurrentScore = 0;
  ...
  document.getElementById('current-score-player1').textContent = "Current Score: 0";
  document.getElementById('current-score-player2').textContent = "Current Score: 0";
...
// function checkWinner() {
//   if (player1TotalScore >= 30) {
//     document.querySelector("h1").innerHTML  = "Player 1 (WINNER) &#128681";
//     dice.disabled = true;
//     hold.disabled = true; 
//   }

//   if (player2TotalScore >= 30) {
//     document.querySelector("h1").innerHTML  = " &#128681 Player 2 (WINNER)";
//     dice.disabled = true; 
